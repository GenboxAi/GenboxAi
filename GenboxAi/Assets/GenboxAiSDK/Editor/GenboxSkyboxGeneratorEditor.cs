...
namespace GenboxAiSDK.Editor
{
    ...
    public class SkyboxGeneratorEditor : UnityEditor.Editor
    {
        ...
        private void OnEnable()
        {
            ...
            {
                InitializeAsync((SkyboxGenerator)target, false);
            }
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            var generator = (SkyboxGenerator)target;

            bool generating = generator.CurrentState == SkyboxGenerator.State.Generating;
            GenboxGUI.DisableGroup(generating, () =>
            {
                ...
                if (generator.CurrentState == SkyboxGenerator.State.NeedApiKey || generator.StyleFamilies?.Count == 0)
                {
                    return;
                }
        ...
        private void DrawApiKey(SkyboxGenerator generator)
        {
            GenboxGUI.Horizontal(() =>
            {
        ...
        private void DrawSkyboxFields(SkyboxGenerator generator)
        {
            GenboxGUI.Horizontal(() =>
            {
        ...
        private void DrawProgress(SkyboxGenerator generator)
        {
            GenboxGUI.Horizontal(() =>
            {
        ...
        private async void InitializeAsync(SkyboxGenerator generator, bool sendAttribution)
        {
            ...
            if (generator.CurrentState != SkyboxGenerator.State.NeedApiKey)
            {
                return;
            }
