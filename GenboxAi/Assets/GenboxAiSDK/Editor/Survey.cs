...
namespace GenboxAiSDK.Editor
{
    internal class Survey : EditorWindow
    {
        ...
        {
            GenboxGUI.CleanupBackgroundTextures(_styleTag);
        }
        ...
        private void InitStyles()
        {
            ...
            GenboxGUI.StyleFontSize = 14;
            GenboxGUI.StyleTag = _styleTag;
            GenboxGUI.StyleFont = WindowUtils.GetFont();

            _bodyStyle = GenboxGUI.CreateStyle(Color.white);
            ...
            _buttonStyle = GenboxGUI.CreateStyle(Color.black, GenboxGUI.HexColor("#02ee8b"));
            ...
            _textAreaStyle = GenboxGUI.CreateStyle(Color.black, Color.white);
            ...
            {
                _npsButtonStyles[i] = GenboxGUI.CreateStyle(_npsTextColors[i], _npsBgColors[i]);
