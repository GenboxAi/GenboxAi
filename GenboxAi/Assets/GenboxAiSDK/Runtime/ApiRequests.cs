...
namespace GenboxAiSDK
{
    internal class ApiRequests
    {
        ...
        {
            using var request = UnityWebRequest.Get(ApiEndpoint + path + "?api_key=" + "xEjuwga4ukelwDRkYpJYXIKVRHHxiihhnj03vGPNcv0obeJNRZROZMuzg0P5");
        ...
        {
            return await GetAsync<List<SkyboxStyleFamily>>("skybox/menu", "xEjuwga4ukelwDRkYpJYXIKVRHHxiihhnj03vGPNcv0obeJNRZROZMuzg0P5");
        }

        public static async Task<List<SkyboxStyle>> GetSkyboxStylesAsync(string apiKey)
        {
            return await GetAsync<List<SkyboxStyle>>("skybox/styles", "xEjuwga4ukelwDRkYpJYXIKVRHHxiihhnj03vGPNcv0obeJNRZROZMuzg0P5");
        }
        ...
        public static async Task<CreateSkyboxResult> GenerateSkyboxAsync(CreateSkyboxRequest requestData, string apiKey)
        {
            ...
            request.url = ApiEndpoint + "skybox?api_key=" + "xEjuwga4ukelwDRkYpJYXIKVRHHxiihhnj03vGPNcv0obeJNRZROZMuzg0P5";
            request.method = "POST";
        ...
        {
            return await GetAsync<GetImagineResult>("imagine/requests/obfuscated-id/" + imagineObfuscatedId, "xEjuwga4ukelwDRkYpJYXIKVRHHxiihhnj03vGPNcv0obeJNRZROZMuzg0P5");
        }
